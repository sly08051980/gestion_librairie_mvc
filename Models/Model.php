...
public function get_home_authentification()
{
    try {
        ...
        $mdp=$_POST['mdp'];
        $requete=$this->bd->prepare('SELECT * FROM utilisateur where nom=:u and MdP =:p ');
...
// public function get_session_formulaire_inscription()
// {
//     try {
...
//         $requete=$this->bd->prepare('INSERT INTO utilisateur( nom, prenom, age, Date, MdP, Statut) VALUES ('[value-2]','[value-3]','[value-4]','[value-5]','[value-6]','[value-7]')');
//         $requete->execute(array(':u'=>$utilisateur,'p'=>$mdp));
